...
public class LowSkinTemp_HealthVitals extends BasePage {
    AlertPage alertPage;
    LoginPage loginPage;
    ...
    public LowSkinTemp_HealthVitals() throws IOException {
        super();
    }
    ...
    public Object[][] getExcelData() throws IOException, InvalidFormatException {
        Object data[][] = TestUtils.dataSupplier("LowSkinTemp",System.getProperty("user.dir")+"\\"+prop.getProperty("Environment")+ prop.getProperty("HealthAlerts"));
        return data;
    }

    @testrail(id="17458")
    @Test(dataProvider="getExcelData",priority = 0)
    public void ValidateUpdatedLowSkinTemp(Map<String, String> map) throws InterruptedException, IOException, ParseException, SQLException, ClassNotFoundException {
        DataSet++;
        test = extent.createTest("Health Vitals -- Validate Updated Low Skin Temperature dashboard after send Alert");
        ...
        int LowTempCountb4 = Integer.parseInt(healthAnalyticsPage.LowSkinTemperatureCount());
        ...
        if( alerts.generateHealthVitalsAlert(map.get("deviceID"),map.get("bpHigh"),map.get("bpLow"),map.get("bpHeart"),map.get("temp"),map.get("lat"),map.get("lon"))){
            ...
            if (prop.getProperty("AlertPopWindowEnabled").equals("true")){
                ...
                utilswrite.WriteInExcel(alertID, DataSet+1, "LowSkinTemp","AlertID",System.getProperty("user.dir")+"\\"+prop.getProperty("Environment")+ prop.getProperty("HealthAlerts"));
            ...
            int LowTempCountAfter = Integer.parseInt(healthAnalyticsPage.LowSkinTemperatureCount());
            ...
            //Fail Test that the alert not generated
    ...
    @testrail(id="17063,17137")
    @Test(dataProvider="getExcelData",priority = 1)
    public void ValidateUpdatedLowSkinTempList(Map<String, String> map) throws InterruptedException, IOException {
        DataSet++;
        ...
        Thread.sleep(2000);
        test.pass("Select the site :"+map.get("Site"));
        healthAnalyticsPage.LowSkinTemperatureClick();
    ...
    public void ValidateLowSkinTempAlert(Map<String, String> map) throws InterruptedException, IOException {
        DataSet++;

        test = extent.createTest("Alert Management -- Validate Low Skin Temperature Alert : "+map.get("AlertID"));
